...
for st=1:2
    ...
    box off
    if st==1
        ylabel('FC_{sed} grassland','fontweight','bold','fontsize',11,'Color','k'); else
        ylabel('FC_{sed} shrubland','fontweight','bold','fontsize',11,'Color','k');end
